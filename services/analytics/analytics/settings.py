...
SIMPLE_JWT = {
    "AUTH_TOKEN_CLASSES": [
        "analytics.authentication.AccessToken",
    ],
...
CELERY_BROKER_URL = os.getenv("CELERY_BROKER_URL", "redis://127.0.0.1:6379/7")
CELERY_RESULT_BACKEND = os.getenv("CELERY_RESULT_BACKEND", "redis://127.0.0.1:6379/8")
